...
class FatHistoryAdapter(private val context: Context, private val listener: IGCHistoryRVAdapter):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FatHistoryViewHolder {
    ...
    override fun onBindViewHolder(holder: FatHistoryViewHolder, position: Int) {
