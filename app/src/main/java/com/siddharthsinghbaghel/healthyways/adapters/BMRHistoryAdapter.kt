...
class BMRHistoryAdapter(private val context: Context, private val listener: IBMRHistoryRVAdapter):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BMRHistoryViewHolder {
    ...
    override fun onBindViewHolder(holder: BMRHistoryViewHolder, position: Int) {
