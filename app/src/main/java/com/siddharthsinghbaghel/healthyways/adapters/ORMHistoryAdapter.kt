...
class ORMHistoryAdapter(private val context: Context, private val listener: IORMHistoryRVAdapter):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ORMHistoryViewHolder {
    ...
    override fun onBindViewHolder(holder: ORMHistoryViewHolder, position: Int) {
