...
class BMIHistoryAdapter(private val context: Context, private val listener: BMIHistoryAdapter.IBMIHistoryRVAdapter):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BMIHistoryAdapter.BMIHistoryViewHolder {
    ...
    override fun onBindViewHolder(holder: BMIHistoryAdapter.BMIHistoryViewHolder, position: Int) {
